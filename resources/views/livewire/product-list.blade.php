        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('product.create') }}" class="btn btn-primary  me-2"><i class="mdi mdi-plus"></i>Add</a>
            ...
            <tr>
                ...
                <td>
                    @if ($product->product_image)
                        <img src="{{ asset('storage/' . $product->product_image) }}" width="40" height="40" class="rounded-circle" />
                    @else
